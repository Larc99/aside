...
extension StatusItemController: NSMenuDelegate {
    func menuWillOpen(_ menu: NSMenu) {
        ...
        menu.addItem(title: "About StickyDeck", symbol: "info.circle", action: #selector(about), keyEquivalent: "", modifier: [])
        menu.addItem(.separator())
        menu.addItem(title: "Quit StickyDeck", symbol: "power", action: #selector(quit), keyEquivalent: "q", modifier: .command)
