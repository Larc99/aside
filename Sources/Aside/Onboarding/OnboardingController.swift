...
final class OnboardingController: NSObject, NSWindowDelegate {
    ...
    /// Aside at a fresh sync folder (D24: separate libraries, no
    ...
    private func seedWelcomeNoteIfLibraryIsNew() async {
        do {
            ...
            NSLog("Aside could not check the library before seeding: %@", error.localizedDescription)
            return
        }
    ...
    private func setLaunchAtLogin(_ enabled: Bool) {
        do {
            ...
            NSLog("Aside could not update Login Items: %@", error.localizedDescription)
        }
    }
    ...
    private func seedWelcomeNote() async {
        ...
        do {
            ...
            NSLog("Aside could not seed the welcome note: %@", error.localizedDescription)
        }
    }
}
